...
class RegistrationControllerApi {
  ...
  Future<Response<UserResponseDTO>> register({ 
    required UserRegisterRequestDTO userRegisterRequestDTO,
    ...
    try {
      const _type = FullType(UserRegisterRequestDTO);
      _bodyData = _serializers.serialize(userRegisterRequestDTO, specifiedType: _type);

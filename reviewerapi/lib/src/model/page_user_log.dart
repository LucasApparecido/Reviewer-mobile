...
/// * [empty] 
@BuiltValue()
abstract class PageUserLog implements Built<PageUserLog, PageUserLogBuilder> {
  ...
  factory PageUserLog([void updates(PageUserLogBuilder b)]) = _$PageUserLog;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PageUserLogBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PageUserLog> get serializer => _$PageUserLogSerializer();
}

class _$PageUserLogSerializer implements PrimitiveSerializer<PageUserLog> {
  @override
  final Iterable<Type> types = const [PageUserLog, _$PageUserLog];

  @override
  final String wireName = r'PageUserLog';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.content != null) {
      ...
      yield serializers.serialize(
        object.content,
        specifiedType: const FullType(BuiltList, [FullType(UserLog)]),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required PageUserLogBuilder result,
  ...
  @override
  PageUserLog deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PageUserLogBuilder();

...
// tests for PageReviewListDTO
void main() {
  // final instance = PageReviewListDTO();

  group('test PageReviewListDTO', () {
    // int totalElements
    ...
    // List<ReviewListDTO> content (default value: const [])
    ...
    // List<SortObject> sort (default value: const [])
